    ...
    <span className="navbar-toggler-icon"></span>
          ...
          <div class="input-icons">
            ...
            <input class="input-field"
              type="text"
              placeholder="Try Saree, Kurti or Search by Product Code" /><br></br>
        ...
        <NavLink className="nav-link" to="/products"><i className="fa fa-product-hunt" aria-hidden="true"></i>Products</NavLink>
              ...
              <li className="nav-item">
                ...
                {/* <span> DowloadApp</span> */}
                {/* <NavLink className="nav-link down" to="https://play.google.com/store/apps/details?id=com.meesho.supply&pid=pow_website&c=pow"> */}
{/* 
                  DowloadApp
                </NavLink> */}
              ...
              <li className="nav-item">
                ...
                <NavLink className="nav-link down" > BecomeaSupplier</NavLink>
              ...
              <li className="nav-item">
                ...
                <NavLink className="nav-link down" to="">
              ...
              <li className="nav-item">
                ...
                <NavLink className="nav-link down" to="/cart">
      ...
      <nav className="navbar navbar-expand-lg navbar-light sec-nav ">
        <div className="container">



          <div className="collapse navbar-collapse" id="navbarSupportedContent sec-nav">
            <ul className="navbar-nav mx-auto">
              ...
              <li className="nav-item active">
                <a className="nav-link down" >WomenWestern <span className="sr-only">(current)</span></a>
              </li>
              <li className="nav-item">
                <a className="nav-link down" >Men</a>
              </li>
              <li className="nav-item">
                <a className="nav-link down">kid's</a>
              </li>
              <li className="nav-item">
                <a className="nav-link down" >Home&Kitchen</a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a className="nav-link down " >Electronics</a>
              </li>
